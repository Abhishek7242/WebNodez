...
mix.js('resources/js/app.js', 'public/js')
    ...
    .css('resources/css/about/intro.css', 'public/css/about/intro.css')
    .css('resources/css/about/clients.css', 'public/css/about/clients.css')
    .css('resources/css/about/services.css', 'public/css/about/services.css')
    .css('resources/css/about/mission-vision.css', 'public/css/about/mission-vision.css')
    .css('resources/css/about/our-story.css', 'public/css/about/our-story.css')
    .css('resources/css/service/intro.css', 'public/css/service/intro.css')
    .css('resources/css/service/service-overview.css', 'public/css/service/service-overview.css')
    .css('resources/css/service/technology.css', 'public/css/service/technology.css')
    .css('resources/css/components/why-choose-us.css', 'public/css/components/')
    .css('resources/css/components/blog-card.css', 'public/css/components/')
    .css('resources/css/components/service-details.css', 'public/css/components/')
    ...
    .css('resources/css/pricing.css', 'public/css')
    .css('resources/css/privacy_policy.css', 'public/css')
    .css('resources/css/blogs.css', 'public/css')
    .css('resources/css/footer.css', 'public/css')
    .css('resources/css/chatbot.css', 'public/css')
    .css('resources/css/blog-page.css', 'public/css')
    ...
    .js('resources/js/mobileNavbar.js', 'public/js')
    .js('resources/js/home.js', 'public/js')
    .js('resources/js/chatbot.js', 'public/js/chatbot.js')
