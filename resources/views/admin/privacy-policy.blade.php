...
@section('main-section')
        ...
        <div id="addForm" class="add-form-container" style="display: none;">
            <div class="form-card">
                <div class="form-header">
                    <h5><i class="fas fa-plus-circle"></i> Add New Policy</h5>
    ...
    <script>
        ...
        let terms = [{
                ...
                description: "We collect personal information such as name, email address, and contact details when you register for our services or contact us for support."
            },
            {
                id: 2,
                title: "Information Usage",
                description: "Your personal information is used to provide and improve our services, communicate with you, and ensure the security of your account."
            },
            {
                id: 3,
            ...
            },
            {
                ...
                description: "We use cookies and similar technologies to enhance your browsing experience and analyze website traffic patterns."
            },
            {
                id: 5,
                title: "Third-Party Sharing",
                description: "We may share your information with trusted third-party service providers who assist us in operating our website and conducting our business."
            }
        ];
                    ...
                    <div class="term-card">
                        <div class="card-content">
                            <div class="card-header">
                                <h5><i class="fas fa-shield-alt"></i> ${term.title}</h5>
