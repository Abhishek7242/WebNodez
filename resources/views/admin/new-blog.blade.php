...
@section('main-section')
    ...
    <div class="blog-editor-container">
        <form class="blog-form-card" method="POST" action="/admin/blog/store" enctype="multipart/form-data">
                ...
                <div class="compact-inputs">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="slug" name="slug" class="form-input"
                            placeholder="your-blog-post-url" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Category</label>
                        <div class="category-options">
                            <div class="category-option" data-value="About Company" data-tooltip="About Company">
                                <i class="fas fa-building"></i>
                            </div>
                            <div class="category-option" data-value="Web Development" data-tooltip="Web Development">
                                <i class="fas fa-code"></i>
                            </div>
                            <div class="category-option" data-value="UI/UX Design" data-tooltip="UI/UX Design">
                                <i class="fas fa-paint-brush"></i>
                            </div>
                            <div class="category-option" data-value="Mobile Development" data-tooltip="Mobile Development">
                                <i class="fas fa-mobile-alt"></i>
                            </div>
                            <div class="category-option" data-value="E-commerce" data-tooltip="E-commerce">
                                <i class="fas fa-shopping-cart"></i>
                            </div>
                            <div class="category-option" data-value="Security" data-tooltip="Security">
                                <i class="fas fa-shield-alt"></i>
                            </div>
                            <div class="category-option" data-value="Artificial Intelligence" data-tooltip="AI">
