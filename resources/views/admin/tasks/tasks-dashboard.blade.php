...
<div class="w-full h-screen">
  <div class="flex flex-col w-full gap-6 justify-between items-center bg-white px-6 py-4 rounded-t-lg shadow-sm">
<div class="flex justify-between w-full">
    ...
    <div>
        <a href="#"
           class="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-900 text-white hover:bg-gray-700 transition">
    ...
    <div class="flex items-center justify-start w-full mt-5 gap-4">
        <!-- Filters -->
      <select class="px-3 py-2 border rounded-full text-sm text-gray-600">
    ...
    <div class="flex justify-start w-full items-center gap-4 ">
        ...
        <div class="flex gap-2">
            <button class="flex font-bold items-center gap-3 px-4 py-2 rounded-full border text-sm text-gray-600 hover:bg-gray-100">
